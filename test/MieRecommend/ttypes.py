...
class Recommend:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'name', None, None, ), # 2
    (3, TType.STRING, 'photo_url', None, None, ), # 3
    (4, TType.STRING, 'telephone', None, None, ), # 4
    (5, TType.STRING, 'address', None, None, ), # 5
    (6, TType.DOUBLE, 'longitude', None, None, ), # 6
    (7, TType.DOUBLE, 'latitude', None, None, ), # 7
    (8, TType.I32, 'distance', None, None, ), # 8
    (9, TType.I32, 'avg_price', None, None, ), # 9
    (10, TType.DOUBLE, 'recommend_mark', None, None, ), # 10
    (11, TType.LIST, 'recommend_reason', (TType.STRING,None), None, ), # 11
    (12, TType.LIST, 'favourite_dishes', (TType.STRUCT,(Dish, Dish.thrift_spec)), None, ), # 12
    (13, TType.LIST, 'deals', (TType.STRUCT,(GroupOn, GroupOn.thrift_spec)), None, ), # 13
  )

  def __init__(self, business_id=None, name=None, photo_url=None, telephone=None, address=None, longitude=None, latitude=None, distance=None, avg_price=None, recommend_mark=None, recommend_reason=None, favourite_dishes=None, deals=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i4 in xrange(_size0):
            ...
            self.recommend_reason.append(_elem5)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.LIST:
          ...
          for _i10 in xrange(_size6):
            _elem11 = Dish()
            _elem11.read(iprot)
            self.favourite_dishes.append(_elem11)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 13:
  ...
  def write(self, oprot):
    ...
    if self.photo_url is not None:
      oprot.writeFieldBegin('photo_url', TType.STRING, 3)
      oprot.writeString(self.photo_url)
      oprot.writeFieldEnd()
    if self.telephone is not None:
      oprot.writeFieldBegin('telephone', TType.STRING, 4)
